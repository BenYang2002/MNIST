...
istraining = true;
isMNIST = true;
weightRows = [1000,10,10];
weightColumns = [784,1000,10];
weightRows1 = [1000,100,10];
weightColumns1 = [784,1000,100];
acceptance_rate = 1;
obj_MNIST = BackPropLayer(weightRows1,weightColumns1,learning_rate,"sigmoid", ...
    acceptance_rate,istraining,trainingTimes,isMNIST);
